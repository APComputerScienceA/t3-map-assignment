...
public class UnitTestMap {
	...
	public static void testGetUserID(User u, int ans) {
		if (u.getUserID() == ans) {
			...
			System.out.println("FAILED - User getUserID: " + ans);
		}
	}
	...
	public static void testGetXVal(User u, double ans) {
		if (u.getXVal() == ans) {
			...
			System.out.println("FAILED - User getXVal: " + ans);
		}
	}
	...
	public static void testGetYVal(User u, double ans) {
		if (u.getYVal() == ans) {
			...
			System.out.println("FAILED - User getYVal: " + ans);
		}
	}
	...
	public static void testMoveUp(User u, double ans) {
		if (u.getYVal() == ans) {
			...
			System.out.println("FAILED - User moveUp: " + ans);
		}
	}
	...
	public static void testMoveDown(User u, double ans) {
		if (u.getYVal() == ans) {
			...
			System.out.println("FAILED - User moveDown: " + ans);
		}
	}
	...
	public static void testMoveLeft(User u, double ans) {
		if (u.getXVal() == ans) {
			...
			System.out.println("FAILED - User moveLeft: " + ans);
		}
	}
	...
	public static void testMoveRight(User u, double ans) {
		if (u.getXVal() == ans) {
			...
			System.out.println("FAILED - User moveRight: " + ans);
		}
	}
	...
	public static void testGetNumUsers(Map m, int ans) {
		if (m.getNumUsers() == ans) {
			...
			System.out.println("FAILED - Map getNumUsers: " + ans);
		}
	}
	...
	public static void testFindClosest(User u, int ans) {
		if (u.getUserID() == ans) {
			...
			System.out.println("FAILED - Map findClosest: " + ans);
		}	
	}
